...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "mdgFGQzI#edFv2Tz3i2pGv2ZzaBUu3kjvv6-H94j6bTBy8tJ6wIU", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94713320156",
DEV: process.env.DEV || "947070700730",
